...
Bluetooth scanning stops when the app leaves the foreground. An active scan also stops if Bluetooth, the required permission, or legacy location services become unavailable.
